...
namespace TnAConfigureProgram
{
    public partial class LCFirmware : Form
    {
        ...
        {
            if (string.IsNullOrEmpty(textBoxIndex.Text) || string.IsNullOrEmpty(textBoxIPAdd.Text) || string.IsNullOrEmpty(textBoxLCIP.Text) || string.IsNullOrEmpty(comboBoxLCFirm.Text))
            {
            ...
            else
            {
                ...
                setIp.setIP(index, textBoxIPAdd.Text, "255.255.255.0");
